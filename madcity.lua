...
local function PoliceESP()
	Library:Notify('Enabled PoliceESP ');
	...
	local function CreateGui(name,parent,face)
		...
		Frame.BackgroundColor3 = Color3.fromRGB(0, 115, 255)
	...
	while wait(0.1) do
		for i,v in pairs(plr:GetPlayers()) do
			if v.TeamColor == BrickColor.new("Bright blue") and v.Name ~= plr.Name and v.Character:FindFirstChild("Head") and v.Character.Head:FindFirstChild("cham") == nil then
...
local function CriminalESP()
	Library:Notify('Enabled CriminalESP ');
	local plr = game.Players
	...
	local function CreateGui(name,parent,face)
		...
		local Frame = Instance.new("Frame",SurfaceGui)
		Frame.BackgroundColor3 = Color3.fromRGB(161, 0, 21)
		Frame.Transparency = 0.4
		Frame.Size = UDim2.new(1,0,1,0)
	end
	...
	while wait(0.1) do
		for i,v in pairs(plr:GetPlayers()) do
			if v.Name ~= plr.LocalPlayer.Name and v.TeamColor == BrickColor.new("Bright red") and v.Name ~= plr.Name and v.Character:FindFirstChild("Head") and v.Character.Head:FindFirstChild("cham") == nil then
				for i,v in pairs(v.Character:GetChildren()) do
					if v:IsA("MeshPart") or v.Name == "Head" then
						CreateGui("cham",v,"Back")
						CreateGui("cham",v,"Top")
...
local function HeroESP()
	Library:Notify('Enabled HeroESP ');
	local plr = game.Players
	...
	local function CreateGui(name,parent,face)
		...
		local Frame = Instance.new("Frame",SurfaceGui)
		Frame.BackgroundColor3 = Color3.fromRGB(208, 184, 0)
		Frame.Transparency = 0.4
		Frame.Size = UDim2.new(1,0,1,0)
	end
	...
	while wait(0.1) do
		for i,v in pairs(plr:GetPlayers()) do
			if v.Name ~= plr.LocalPlayer.Name and v.TeamColor == BrickColor.new("Bright yellow") and v.Name ~= plr.Name and v.Character:FindFirstChild("Head") and v.Character.Head:FindFirstChild("cham") == nil then
				for i,v in pairs(v.Character:GetChildren()) do
					if v:IsA("MeshPart") or v.Name == "Head" then
						CreateGui("cham",v,"Back")
						CreateGui("cham",v,"Top")
...
local function VillianESP()
	Library:Notify('Enabled VillianESP ');
	local plr = game.Players
	...
	local function CreateGui(name,parent,face)
		...
		local Frame = Instance.new("Frame",SurfaceGui)
		Frame.BackgroundColor3 = Color3.fromRGB(111, 0, 208)
		Frame.Transparency = 0.4
		Frame.Size = UDim2.new(1,0,1,0)
	end
	...
	while wait(0.1) do
		for i,v in pairs(plr:GetPlayers()) do
			if v.Name ~= plr.LocalPlayer.Name and v.TeamColor == BrickColor.new("Bright violet") and v.Name ~= plr.Name and v.Character:FindFirstChild("Head") and v.Character.Head:FindFirstChild("cham") == nil then
				for i,v in pairs(v.Character:GetChildren()) do
					if v:IsA("MeshPart") or v.Name == "Head" then
						CreateGui("cham",v,"Back")
						CreateGui("cham",v,"Top")
...
local function PrisonerESP()
	Library:Notify('Enabled PrisonerESP ');
	local plr = game.Players
	...
	local function CreateGui(name,parent,face)
		...
		local Frame = Instance.new("Frame",SurfaceGui)
		Frame.BackgroundColor3 = Color3.fromRGB(208, 121, 0)
		Frame.Transparency = 0.4
		Frame.Size = UDim2.new(1,0,1,0)
	end
	...
	while wait(0.1) do
		for i,v in pairs(plr:GetPlayers()) do
			if v.Name ~= plr.LocalPlayer.Name and v.TeamColor == BrickColor.new("Bright orange") and v.Name ~= plr.Name and v.Character:FindFirstChild("Head") and v.Character.Head:FindFirstChild("cham") == nil then
				for i,v in pairs(v.Character:GetChildren()) do
					if v:IsA("MeshPart") or v.Name == "Head" then
						CreateGui("cham",v,"Back")
						CreateGui("cham",v,"Top")
...
MainTabber:AddButton('ZoomSpeed [H]', ZoomSpeed);
...
VisualsTabber:AddButton('[ESP] Prisoners',PrisonerESP )
VisualsTabber:AddButton('[ESP] Police',PoliceESP )
VisualsTabber:AddButton('[ESP] Criminal',CriminalESP )
VisualsTabber:AddButton('[ESP] Heroes',HeroESP )
VisualsTabber:AddButton('[ESP] Villains',VillianESP )
